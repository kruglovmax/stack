...
stacks: []          # список стеков, для выполнения _пледовательно_, которые будут выполняться после завершения выполнения данного стека
pstacks: []         # список стеков, для выполнения _параллельно_, которые будут выполняться после завершения выполнения данного стека
postRun: []
